...
java_project_dir="/data/illumina_pipeline/scripts/GitHub/java_motif_processing/"

# Enter the package name
package_name="motif_processing"
...
jar_file_name="motif-processing"
...
# Create the jar
jar -cvmf \
${java_project_dir}src/motif_processing/motif-processing.manifest \
